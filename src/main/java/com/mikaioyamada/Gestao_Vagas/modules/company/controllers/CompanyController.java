...
import com.mikaioyamada.Gestao_Vagas.modules.company.useCases.CreateCompanyUseCase;
...
public class CompanyController {
    ...
    public ResponseEntity<Object> create(@Valid @RequestBody CompanyEntity companyEntity){
        try {
            var result = this.createCompanyUseCase.execute(companyEntity); // metodo localizado em useCase/createCompanyUseCase
